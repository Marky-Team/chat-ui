...
export const handlers = [
  ...
  http.get("https://api.example.com/api/threads/:threadId/messages", ({ params }) => {
  ...
  http.post("https://api.example.com/api/threads/:threadId/messages", async ({ params, request }) => {
  ...
  http.post("https://api.example.com/api/threads/:threadId/history", async ({ params, request }) => {
    const history = [
      {
        values: {
          messages: [
            ...
            {
              content: "Hello! How can I assist you with your graphic design needs today?",
              additional_kwargs: {},
              response_metadata: {
                finish_reason: "stop",
  ...
  http.post("https://api.example.com/api/threads/:threadId/runs/stream", async ({ request }) => {
